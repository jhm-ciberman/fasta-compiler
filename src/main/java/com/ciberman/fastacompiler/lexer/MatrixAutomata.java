...
public class MatrixAutomata implements Automata {
    ...
    public MatrixAutomata() {
        ...
        this.transitions = new int[][] {
            ...
            { F       , F       , F       , F       , F       , 1       , F       , 1       , F        , 1         , 1       , F       , F       , F       , F       , F       , F       , F       , F       , F       , F       , F       , F       , F       , F       , F        },
        ...
        this.tokenTypes = new TokenType[][] {
            ...
            { ID      , ID      , ID      , ID      , ID      , null    , ID      , null    , ID       , null      , null    , ID      , ID      , ID      , ID      , ID      , ID      , ID      , ID      , ID      , ID      , ID      , ID      , ID      , ID      , ID       },
        ...
        this.semanticActions = new SemanticAction[][] {
            ...
            { ChekId  , ChekId  , ChekId  , ChekId  , ChekId  , Save    , ChekId  , Save    , ChekId   , Save      , Save    , ChekId  , ChekId  , ChekId  , ChekId  , ChekId  , ChekId  , ChekId  , ChekId  , ChekId  , ChekId  , ChekId  , ChekId  , ChekId  , ChekId  , ChekId   },
